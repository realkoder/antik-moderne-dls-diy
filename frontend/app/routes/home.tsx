    ...
    <div className="w-full flex flex-col justify-center items-center">
      <div className="flex flex-col w-[95%] h-[700px]">
        ...
        <div className="absolute flex flex-col top-1/5 left-1/5">
          <h1 className="text-6xl text-white text-left font-bold mb-4">
            Welcome to Antik Moderne
          </h1>
      ...
      <div className="flex items-center w-[90%]">
        <h1 className="text-6xl text-black text-center font-bold mb-10 pt-10 mr-6">
          Featured Posters
        </h1>
        <NavLink
          to="/posters"
